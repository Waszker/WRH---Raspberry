    ...
    def get_html_representation(self, website_host_address):
        ...
        return '<div style="border:1px solid black;"> \
               ...
               getState' + my_id + '(); \n\
                    ...
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'ON\', 5, \'relay1_' + my_id + '\')">ON</button></td> \
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'OFF\', 5, null)">OFF</button></td></tr> \
                    <tr>\
                    <td>Relay&nbsp;2</td> \
                    <td><div style="margin: 3%; width: 100%"><input id=\"relay2_' + my_id + '\" type=\"number\" style="width: 90%" value="10"/></div></td> \
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'ON\', 4, \'relay2_' + my_id + '\')">ON</button></td> \
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'OFF\', 4, null)">OFF</button></td></tr> \
                    <tr>\
                    <td>Relay&nbsp;3</td> \
                    <td><div style="margin: 3%; width: 100%"><input id=\"relay3_' + my_id + '\" type=\"number\" style="width: 90%" value="10"/></div></td> \
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'ON\', 15, \'relay3_' + my_id + '\')">ON</button></td> \
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'OFF\', 15, null)">OFF</button></td></tr> \
                    <tr>\
                    <td>Relay&nbsp;4</td> \
                    <td><div style="margin: 3%; width: 100%"><input id=\"relay4_' + my_id + '\" type=\"number\" style="width: 90%" value="10"/></div></td> \
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'ON\', 4, \'relay4_' + my_id + '\')">ON</button></td> \
                    <td><button style="margin: 10%" type="button" onclick="setState' + my_id + '(\'OFF\', 5, -1)">OFF</button></td></tr> \
                    </table> \
               </div>'
